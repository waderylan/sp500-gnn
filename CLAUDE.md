...
- [x] 5.3 Significance tests (DM + BH FDR + block bootstrap) → `dm_test_results.csv`, `bootstrap_sharpe_ci.csv`, `significance_summary.csv` · `notebooks/07_significance.ipynb`: display significance summary table
- [x] 5.4 Figure generation (8 publication figures) · `notebooks/07_significance.ipynb`: confirm all 8 PNGs saved to `data/results/figures/`
